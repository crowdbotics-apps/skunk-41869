"""
Django settings for skunk_41869 project.
...
WSGI_APPLICATION = 'skunk_41869.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skunk_41869 API",
    "DESCRIPTION": "API documentation for skunk_41869 App",
    "VERSION": "v1",
}
